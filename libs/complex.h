...
void complex_add(complex_p num1, complex_p num2, heap_p heap);
void complex_add_int(complex_p num1, int_p num2, heap_p heap);
void complex_add_float(complex_p num1, float_p num2, heap_p heap);
...
void complex_int_subtract(int_p num1, complex_p num2, heap_p heap);
void complex_subtract_float(complex_p num1, float_p num2, heap_p heap);
void complex_float_subtract(float_p num1, complex_p num2, heap_p heap);

void complex_multiply(complex_p num1, complex_p num2, heap_p heap);
void complex_multiply_int(complex_p num1, int_p num2, heap_p heap);
void complex_multiply_float(complex_p num1, float_p num2, heap_p heap);

void complex_divide(complex_p num1, complex_p num2, heap_p heap);
void complex_divide_int(complex_p num1, int_p num2, heap_p heap);
...
void complex_power(complex_p num1, complex_p num2, heap_p heap);
void complex_power_int(complex_p num1, int_p num2, heap_p heap);
void complex_int_power(int_p num1, complex_p num2, heap_p heap);
complex_p complex_int_power_float(int_p num1, float_p num2, unsigned long long prec, cellular_p cellular, heap_p heap);
void complex_power_float(complex_p num1, float_p num2, heap_p heap);
void complex_float_power(float_p num1, complex_p num2, heap_p heap);
