...
static const char* bi_func_names[6] =
{
    "print",
    "input",
    "typeof",
...
static const unsigned long long bi_func_min_sizes[6] = { 0, 0, 1, 0, 1, 1 };
static const unsigned long long bi_func_max_sizes[6] = { 2, 1, 1, 0, 1, 1 };
